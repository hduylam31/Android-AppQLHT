    ...
    <TouchableWithoutFeedback onPress={handlePress}>
      <SafeAreaView className="flex-1 bg-[#3A4666]">
        <View className="w-full h-[45%] bg-[#23ACCD] rounded-b-[50px]">
          ...
          <View className="w-42 h-60 bg-white rounded-2xl mx-6 mt-10 flex justify-center items-center space-y-4">
            <TextInput
              placeholder="Email"
              value={email}
              onChangeText={(text) => setEmail(text)}
              className="w-[80%] h-[30%] bg-[#D9D9D9] pl-4"
            ></TextInput>
            <TextInput
          ...
          <TouchableOpacity onPress={handleLogin}>
            <Animatable.View
              ...
              className="w-[85%] h-[40%] items-center justify-center bg-[#FE8668] self-center rounded-2xl mt-[10%]"
              style={{
                shadowColor: "#000",
